...
export default function Home() {
  return <main id="contenido">
    ...
    <section className="shell intelligence-preview"><div><p className="kicker">UN SISTEMA QUE APRENDE SIN SER UNA CAJA NEGRA</p><h2>Primero aprende de vos.<br/>Después compara entre personas.</h2><Link href="/learning">Ver qué está aprendiendo →</Link></div><div className="intelligence-levels"><article><span>01 · PERSONAL</span><h3>Adapta la próxima sesión</h3><p>Compara tus respuestas con los controles, repite sonidos prometedores y explora otros cuando no encuentra una diferencia.</p></article><article><span>02 · COLECTIVO</span><h3>Sólo si elegís aportar</h3><p>Suma respuestas anónimas de muchas personas. Nunca incluye tu texto libre, correo, cuenta ni identificador de sesión.</p></article><article><span>03 · HONESTO</span><h3>Puede aprender que no hay efecto</h3><p>Una señal no gana prioridad por una respuesta aislada: debe repetirse, superar controles y reducir incertidumbre.</p></article></div></section>
